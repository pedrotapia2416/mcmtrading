...
function calcular() {
  ...
  tabla3.innerHTML = "";
    ...
    const precioInteraccion1 = precio * porcentajeUnico;
    ...
    const precioInteraccion2 = precioInteraccion1 * porcentajeUnico;
    ...
    const precioPromedio2 = (precioInteraccion2 + precioInteraccion1 + precio)/3;
     ...
     const precioInteraccion3 = precioInteraccion2 * porcentajeUnico;
    ...
    const precioPromedio3 = (precioInteraccion2 + precioInteraccion1 + precioInteraccion3)/3;
     ...
     const precioInteraccion4 = precioInteraccion3 * porcentajeUnico;
    ...
    const precioPromedio4 = (precioInteraccion2 + precioInteraccion4 + precioInteraccion3)/3;
     ...
     const precioInteraccion5 = precioInteraccion4 * porcentajeUnico;
    ...
    const precioPromedio5 = (precioInteraccion5 + precioInteraccion4 + precioInteraccion3)/3;
     ...
     const precioInteraccion6 = precioInteraccion5 * porcentajeUnico;
     ...
     const precioInteraccion7 = precioInteraccion6 * porcentajeUnico;
