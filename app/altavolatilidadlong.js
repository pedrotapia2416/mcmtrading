...
function calcular() {
  ...
  tabla3.innerHTML = "";
    ...
    const precioInteraccion1 = precio - (precio * 0.08);
    ...
    const precioInteraccion2 = precioInteraccion1  - (precioInteraccion1 * 0.08);
    ...
    const precioPromedio2 = (precioInteraccion2 + precioInteraccion1 + precio)/3;
     ...
     const precioInteraccion3 = precioInteraccion2  - (precioInteraccion2 * 0.09);
    ...
    const precioPromedio3 = (precioInteraccion2 + precioInteraccion1 + precioInteraccion3)/3;
     ...
     const precioInteraccion4 = precioInteraccion3  - (precioInteraccion3 * 0.09);
    ...
    const precioPromedio4 = (precioInteraccion2 + precioInteraccion4 + precioInteraccion3)/3;
     ...
     const precioInteraccion5 = precioInteraccion4  - (precioInteraccion4 * 0.12);
    ...
    const precioPromedio5 = (precioInteraccion5 + precioInteraccion4 + precioInteraccion3)/3;
     ...
     const precioInteraccion6 = precioInteraccion5  - (precioInteraccion5 * 0.14);
     ...
     const precioInteraccion7 = precioInteraccion6  - (precioInteraccion6 * 0.20);
