function calcular() {
  ...
  const precioInteraccion1 = precio * 1.02;
  ...
  const precioInteraccion2 = precioInteraccion1 * 1.02;
  ...
  const resultadoInteraccion2 = precioInteraccion2 * monedaInteraccion2;
   ...
   const precioInteraccion3 = precioInteraccion2 * 1.02;
   ...
   const precioInteraccion4 = precioInteraccion3 * 1.03;
   ...
   const precioInteraccion5 = precioInteraccion4 * 1.03;
   ...
   const precioInteraccion6 = precioInteraccion5 * 1.03;
   ...
   const precioInteraccion7 = precioInteraccion6 * 1.04;
...
const precioStockOut = precioInteraccion7 * 1.01;
...
const gananciaUSDT = usdtStockOut / apalancamiento;
  ...
  celda1Interaccion1.appendChild(document.createTextNode(`$${precioInteraccion1}`));
